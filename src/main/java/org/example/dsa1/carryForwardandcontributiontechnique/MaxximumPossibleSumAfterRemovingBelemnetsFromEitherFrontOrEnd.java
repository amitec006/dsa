...
public class MaxximumPossibleSumAfterRemovingBelemnetsFromEitherFrontOrEnd {
    /**
     ...
     *
     * Find and return the maximum possible sum of the B
     * elements that were removed after the B operations.
     *
